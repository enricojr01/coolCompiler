...
public class CoolParser extends Parser {
	...
	public static final int
		...
		T__31=32, T__32=33, T__33=34, T__34=35, T__35=36, CLASS=37, ELSE=38, FI=39, 
		IF=40, IN=41, INHERITS=42, ISVOID=43, LET=44, LOOP=45, POOL=46, THEN=47, 
		WHILE=48, CASE=49, ESAC=50, NEW=51, OF=52, NOT=53, SELF=54, SELF_TYPE=55, 
		TRUE=56, FALSE=57, TYPE=58, ID=59, INTEGER=60, STRING=61, WHITESPACE=62, 
		SEMICOLON=63, BLOCKCOMMENT=64, INLINECOMMENT=65;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'in'", "'case'", "'of'", "'=>'", "'esac'", "'new'", "'isVoid'", "'}'", 
			"'+'", "'-'", "'*'", "'/'", "'~'", "'<'", "'>'", "'<='", "'>='", "'='", 
			"'not'", null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, "'self'", "'SELF_TYPE'", "'true'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"SELF", "SELF_TYPE", "TRUE", "FALSE", "TYPE", "ID", "INTEGER", "STRING", 
			"WHITESPACE", "SEMICOLON", "BLOCKCOMMENT", "INLINECOMMENT"
		};
	}
	...
	public final MethodDefinitionContext methodDefinition() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4269412516566287426L) != 0)) {
				{
				{
				setState(81);
				expr(0);
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4269412516566287426L) != 0)) {
					{
					setState(98);
					expr(0);
					setState(103);
