...
public class CoolLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "T__20", "T__21", "CLASS", "ELSE", "FI", "IF", 
			"IN", "INHERITS", "ISVOID", "LET", "LOOP", "POOL", "THEN", "WHILE", "CASE", 
			"ESAC", "NEW", "OF", "NOT", "SELF", "SELF_TYPE", "TRUE", "FALSE", "TYPE", 
			"ID", "INTEGER", "STRING", "WHITESPACE", "SEMICOLON", "BLOCKCOMMENT", 
			"INLINECOMMENT", "CAPITAL", "LOWERCA", "DIGITS", "UNDERSC"
		};
	}
